...
namespace Ecommerce.Clases
{
    ...
    {
        private static ApplicationDbContext userContext = new ApplicationDbContext(); //contexto de la app
        private static EcommerceContext db = new EcommerceContext(); // contexto de la bd ecommerce
